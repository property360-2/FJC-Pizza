...
#
# SQLite is used exclusively for now to simplify local school development and testing.
# This ensures that no PostgreSQL external database drivers or environment variables
# are required to run the core sales and inventory management application.
DATABASES = {
    "default": {
...
# Email Configuration & SMTP Setup with Smart Console Fallback
EMAIL_HOST_USER = os.getenv("EMAIL_HOST_USER", "")
EMAIL_HOST_PASSWORD = os.getenv("EMAIL_HOST_PASSWORD", "")

if not EMAIL_HOST_USER or not EMAIL_HOST_PASSWORD:
    # If no credentials exist, fallback to console printer so local order checkout never crashes
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "FCJ Pizza <receipts@fcjpizza.com>")
